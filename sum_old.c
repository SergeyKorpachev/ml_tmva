void sum_part1( int nfiles = 6 );

void sum_part2( int nfiles = 3 );


void sum() {
    int nfiles_part1 = 6;
    int nfiles_part2 = 3;
    sum_part1( nfiles_part1 );
    sum_part2( nfiles_part2 );
}

void sum_part1( int nfiles = 6 ) {
  
    char fname[ 120 ];
    int mass_energy[] = { 5, 10, 15, 20, 25, 30 };
    int energy_count[] = { 0, 0, 0, 0, 0, 0 };
    unsigned int nEvents[] = { 0, 0, 0, 0, 0, 0 };
...
void sum_part2( int nfiles = 3 ) {
    ...
    char fname[ 120 ];
    int mass_energy[] = { 40, 50, 60 };
    int energy_count[] = { 0, 0, 0 };
    unsigned int nEvents[] = { 0, 0, 0 };
