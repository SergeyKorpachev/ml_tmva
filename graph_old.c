...
*/
   FILE *file = fopen("out0.txt", "r");
   if ( !(long)file ) return;

   FILE *file2 = fopen("out1.txt", "r");
   if ( !(long)file2 ) return;

   FILE *file3 = fopen("out2.txt", "r");
   if ( !(long)file3 ) return;

   FILE *file4 = fopen("out3.txt", "r");
   if ( !(long)file4 ) return;

   FILE *file5 = fopen("out4.txt", "r");
...
//   egr->SetMarkerSize(2);
   ...
   cgr->GetXaxis()->SetTitle("Energy, GeV");
   dgr = new TGraphErrors( n, energy4, sigma4, energyerror4, sigmaerror4 );
   dgr->GetYaxis()->SetTitle("Sigma, GeV");
   dgr->GetXaxis()->SetTitle("Energy, GeV");
   egr = new TGraphErrors( n, energy5, sigma5, energyerror5, sigmaerror5 );
...
//   egr->SetMarkerSize(2);
   ...
   cgr->GetXaxis()->SetTitle("Energy, GeV");
   dgr = new TGraphErrors( n, energy4, value4, energyerror4, error4 );
   dgr->GetYaxis()->SetTitle("Sigma / Mean");
   dgr->GetXaxis()->SetTitle("Energy, GeV");
   egr = new TGraphErrors( n, energy5, value5, energyerror5, error5 );
